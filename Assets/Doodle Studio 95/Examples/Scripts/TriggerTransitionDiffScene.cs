...
namespace DoodleStudio95Examples
{
    ...
    public class TriggerTransitionDiffScene : MonoBehaviour
    {

        public string changeScene; //define a scene by the name to transition to
        ...
        IEnumerator Transition()
        {
            ...
            yield return SceneManager.LoadSceneAsync(changeScene);
    ...
    }//end of monobehavior declaration
